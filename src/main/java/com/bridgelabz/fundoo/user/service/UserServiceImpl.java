...
public  class UserServiceImpl implements UserService {
	Path location=Paths.get("/home/admin1/Desktop/Dj.jpg");
	//String location="/home/admin1/Desktop/Dj.jpg";
	...
	@Autowired
	private RefResponse statusResponse;
	...
	@Override
	public RefResponse onRegister(UserDTO userDto) {
		...
		if (alreadyPresent.isPresent()) {
			throw new UnavailableException(environment.getProperty("status.register.emailExistError"));
		}
	...
	public ResponseBody onLogin(LoginDTO loginDto) {
	...
	@Override
	public ResponseBody authentication(Optional<User> user, String password) {

		ResponseBody response = new ResponseUtil();
	...
	@Override
	public RefResponse validateEmailId(String token) {
	...
	@Override
	public RefResponse forgetPassword(EmailDTO emailDto) throws UserException, UnsupportedEncodingException {
